...
template <typename T>
typename string_tokens_traits<T>::type GetStringTokens(const typename string_tokens_traits<T>::string_type& str, const T* separators)
{
    typename string_tokens_traits<T>::type string_tokens;
    GetStringTokens(str, separators, string_tokens);

    return string_tokens;
}

template <typename T>
void GetStringTokens(const typename string_tokens_traits<T>::string_type& str, const T* separators, typename string_tokens_traits<T>::type& string_tokens)
{
